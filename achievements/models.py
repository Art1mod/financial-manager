...
class Achievement(models.Model):
    """Represents a global milestone rule that users can unlock."""
...
class UserAchievement(models.Model):
    """Junction table tracking which user has unlocked which achievement and when."""
    ...
    class Meta:
        unique_together = ('user', 'achievement') # Prevents duplicate unlocks
